...
private Button Motor1, Motor2, Motor3, Pack1, Pack2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Motor1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Motor1.setBackgroundColor(ContextCompat.getColor(Order1Activity.this,R.color.colorPrimary));
        ...
        Motor2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Motor2.setBackgroundColor(ContextCompat.getColor(Order1Activity.this,R.color.colorPrimary));
        ...
        Motor3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Motor3.setBackgroundColor(ContextCompat.getColor(Order1Activity.this,R.color.colorPrimary));
                Motor1.setBackgroundResource(android.R.drawable.btn_default);
                Motor2.setBackgroundResource(android.R.drawable.btn_default);
        ...
        Pack1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Pack1.setBackgroundColor(ContextCompat.getColor(Order1Activity.this,R.color.colorPrimary));
        ...
        Pack2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Pack2.setBackgroundColor(ContextCompat.getColor(Order1Activity.this,R.color.colorPrimary));
    ...
    public void onOrder1(View view) {
        Intent intent = new Intent(Order1Activity.this, MainActivity.class);
